...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    watch: {
      ...
      js: {
        files: ['<%= bensAngularSeed.app %>/scripts/{,*/}*.js'],
      ...
      livereload: {
        ...
        files: [
          '<%= bensAngularSeed.app %>/{,*/}*.html',
          '<%= bensAngularSeed.app %>/content/images/{,*/}*.{png,jpg,jpeg,gif,webp,svg}',
          '<%= bensAngularSeed.app %>/lib/css/*.css'
        ]
      }
    },
    ...
    jshint: {
      ...
      all: {
        src: [
          'Gruntfile.js',
          '<%= bensAngularSeed.app %>/scripts/{,*/}*.js'
        ]
      },
      test: {
        options: {
    ...
    wiredep: {
      app: {
        src: ['<%= bensAngularSeed.app %>/index.html'],
        ignorePath:  /\.\.\//
      },
      test: {
